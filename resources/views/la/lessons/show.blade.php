...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $lesson->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Lessons", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/lessons/'.$lesson->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Lessons", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.lessons.destroy', $lesson->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/lessons') }}" data-toggle="tooltip" data-placement="right" title="Back to Lessons"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'lesson_title')
						@la_display($module, 'course_id')
						@la_display($module, 'description')
						@la_display($module, 'published')
						@la_display($module, 'lesson_image')
					</div>
				</div>
			</div>
		</div>
