...
class CreateDelementPparametersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Delement_pparameters", 'delement_pparameters', 'linguistic_term', 'fa-cube', [
            ["linguistic_term", "Linguistic Term", "String", false, "", 0, 256, true],
    ...
    {
        if (Schema::hasTable('delement_pparameters')) {
            Schema::drop('delement_pparameters');
        }
    }
}
